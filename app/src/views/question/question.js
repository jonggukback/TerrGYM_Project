...
const firebaseConfig = {
  ...
  databaseURL:
    "https://semi-project-7a423-default-rtdb.asia-southeast1.firebasedatabase.app",
...
//const q = query(collection(db, "QUESTION"), orderBy("date", "asc"));
...
//     <tr>
//       <th scope="row">${++num}</th>
//       <td><a href="./questionmodal.html?id=${doc.id}">${doc.data().title}</a></td>
//       <td>${doc.data().type}</td>
//       <td>${doc.data().date}</td>
//     </tr>
//   `;
